...
<title>Admin-Apprenants </title>
</head>
<body>
	<nav class="navbar navbar-dark bg-primary">
		<a class="navbar-brand" href="${pageContext.request.contextPath}/Admin"><img style="margin: auto;"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/List-Apprenant">Apprenants
						<span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/List-Reservation">Reservation
						<span class="sr-only">(current)</span>
				</a></li>
			</ul>
	...
	<br>
	<div>
		<h1 style="text-align: center;">Neveau Apprenants Pas Accepter</h1>
	</div>
	<br>
	<br>
	<div>
		<table class="table table-dark">
			<thead>
				...
				<tr>
					<th scope="col">ID Appenants</th>
					<th scope="col">NOM Appenants</th>
					<th scope="col">EMAIL Appenants</th>
			...
			<tbody>
				<s:forEach items="${listApp}" var="l">
					<tr>
						<th scope="row">${l.id_user}</th>
						<td>${l.nom_user}</td>
						<td>${l.email_user}</td>

						<td>
							<form action="AccepteApp" method="post">
								<input style="display: none;" name="Accepte"
									value="${l.id_user}">
								<button class="btn btn-primary">Accepte</button>
							</form>
						</td>
						<td>
							<form action="RefuseApp" method="post">
								<input style="display: none;" name="Refuse" value="${l.id_user}">
