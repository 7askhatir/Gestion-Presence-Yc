...
<body>
	<div class="page">
				...
				<div class="login-methods">
					<div>
						<img
							...
							height="40px" width="160px" alt="">
					</div>
					<div class="login-methods-login btn-gray">
						<a href="${pageContext.request.contextPath}/inscreption"
							style="text-decoration: none; color: #007bff;">Inscreption</a>
					</div>
				</div>
				<form method="post" action="loginForm">
					<div class="form-message">
						<div class="form-message-title">Bienvenu</div>
						<div class="form-message-body">Connecter pour reserver votre
							PLACE</div>
					</div>
					<div class="form-body">
		...
		<div class="pic" style="background-color: #007bff; order: 0;"></div>
	</div>
</body>
</html>